...
)](https://pkg.go.dev/github.com/avalanria/go-avalanria?tab=doc)
[![Go Report Card](https://goreportcard.com/badge/github.com/avalanria/go-avalanria)](https://goreportcard.com/report/github.com/avalanria/go-avalanria)
[![Travis](https://travis-ci.com/avalanria/go-avalanria.svg?branch=master)](https://travis-ci.com/avalanria/go-avalanria)
[![Discord](https://img.shields.io/badge/discord-join%20chat-blue.svg)](https://discord.gg/nthXNEv)

Automated builds are available for stable releases and the unstable master branch. Binary
archives are published at https://gavn.avalanria.org/downloads/.

## Building the source

For prerequisites and detailed build instructions please read the [Installation Instructions](https://gavn.avalanria.org/docs/install-and-build/installing-gavn).
...
|   `puppavn`   | a CLI wizard that aids in creating a new Avalanria network.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

## Running `gavn`

Going through all the possible command line flags is out of scope here (please consult our
[CLI Wiki page](https://gavn.avalanria.org/docs/interface/command-line-options)),
 ...
 * Start up `gavn`'s built-in interactive [JavaScript console](https://gavn.avalanria.org/docs/interface/javascript-console),
   ...
   as well as `gavn`'s own [management APIs](https://gavn.avalanria.org/docs/rpc/server).
 ...
 * Instead of connecting the main Avalanria network, the client will connect to the Görli
   ...
   states.
 * Instead of using the default data directory (`~/.avalanria` on Linux for example), `gavn`
   will nest itself one level deeper into a `goerli` subfolder (`~/.avalanria/goerli` on
...
```shell
docker run -d --name avalanria-node -v /Users/alice/avalanria:/root \
...
and [`gavn` specific APIs](https://gavn.avalanria.org/docs/rpc/server)).
...
and the [avnminer](https://github.com/avalanria-mining/avnminer) repository.
...
If you'd like to contribute to go-avalanria, please fork, fix, commit and send a pull request
...
Please see the [Developers' Guide](https://gavn.avalanria.org/docs/developers/devguide)
for more details on configuring your environment, managing project dependencies, and
testing procedures.

## License

The go-avalanria library (i.e. all code outside of the `cmd` directory) is licensed under the
[GNU Lesser General Public License v3.0](https://www.gnu.org/licenses/lgpl-3.0.en.html),
also included in our repository in the `COPYING.LESSER` file.

The go-avalanria binaries (i.e. all code inside of the `cmd` directory) is licensed under the
