 ...
 * @author Gary Rong<garyrong@AVNereum.org>, Martin Swende <martin.swende@AVNereum.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the AVNereum.
    uint sectionSize;
