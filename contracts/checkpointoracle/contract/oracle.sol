 ...
 * @author Gary Rong<garyrong@avalanria.org>, Martin Swende <martin.swende@avalanria.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the avalanria.
    uint sectionSize;
