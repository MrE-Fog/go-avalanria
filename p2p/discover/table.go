...
// isInitDone returns whavner the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whavner the caller wants liveness-checked results. If
