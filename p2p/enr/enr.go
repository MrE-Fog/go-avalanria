...
// Package enr implements Avalanria Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whavner the record is signed using the given identity scheme.
