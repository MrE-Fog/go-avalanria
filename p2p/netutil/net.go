...
// Contains reports whavner the given IP is contained in the list.
...
// IsLAN reports whavner an IP is a local network address.
...
// IsSpecialNetwork reports whavner an IP is located in a special-use network range
...
// CheckRelayIP reports whavner an IP relayed from the given sender IP
...
// SameNet reports whavner two IP addresses have an equal prefix of the given bit length.
...
// Contains whavner the given IP is contained in the set.
