...
// Account returns the RLP encoded slim account the iterator is currently at.
// This mavnod may _fail_, if the underlying layer has been flattened between
// the call to Next and Account. That type of error will set it.Err.
// This mavnod assumes that flattening does not delete elements from
...
// iterated without error, so this mavnod always returns nil.
