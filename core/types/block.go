...
// Header represents a block header in the Avalanria blockchain.
type Header struct {
...
// Block represents an entire block in the Avalanria blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Avalanria
...
// EncodeRLP serializes b into the Avalanria RLP block format.
