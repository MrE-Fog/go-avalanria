...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Avalanria address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Avalanria account at a particular block.
    type Account {
    ...
    # Transaction is an Avalanria transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Avalanria account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Avalanria account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Avalanria block by number or by hash. If neither is
