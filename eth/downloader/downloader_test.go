...
type downloadTester struct {
	...
	stateDb avndb.Database // Database used by the tester for syncing from peers
	peerDb  avndb.Database // Database of the peers containing all data
...
// This mavnod assumes that the caller holds at least the read-lock (dl.lock)
func (dl *downloadTester) getHeaderByHash(hash common.Hash) *types.Header {
...
// RequestBodies constructs a getBlockBodies mavnod associated with a particular
...
// RequestReceipts constructs a getReceipts mavnod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
...
// RequestNodeData constructs a getNodeData mavnod associated with a particular
// peer in the download tester. The returned function can be used to retrieve
...
func assertOwnChain(t *testing.T, tester *downloadTester, length int) {
	// Mark this mavnod as a helper to report errors at callsite, not in here
	t.Helper()
...
func TestCanonicalSynchronisation65Full(t *testing.T)  { testCanonSync(t, avn.AVN65, FullSync) }
func TestCanonicalSynchronisation65Fast(t *testing.T)  { testCanonSync(t, avn.AVN65, FastSync) }
func TestCanonicalSynchronisation65Light(t *testing.T) { testCanonSync(t, avn.AVN65, LightSync) }

func TestCanonicalSynchronisation66Full(t *testing.T)  { testCanonSync(t, avn.AVN66, FullSync) }
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, avn.AVN66, FastSync) }
func TestCanonicalSynchronisation66Light(t *testing.T) { testCanonSync(t, avn.AVN66, LightSync) }
...
func TestThrottling65Full(t *testing.T) { testThrottling(t, avn.AVN65, FullSync) }
func TestThrottling65Fast(t *testing.T) { testThrottling(t, avn.AVN65, FastSync) }

func TestThrottling66Full(t *testing.T) { testThrottling(t, avn.AVN66, FullSync) }
func TestThrottling66Fast(t *testing.T) { testThrottling(t, avn.AVN66, FastSync) }
...
func TestForkedSync65Full(t *testing.T)  { testForkedSync(t, avn.AVN65, FullSync) }
func TestForkedSync65Fast(t *testing.T)  { testForkedSync(t, avn.AVN65, FastSync) }
func TestForkedSync65Light(t *testing.T) { testForkedSync(t, avn.AVN65, LightSync) }

func TestForkedSync66Full(t *testing.T)  { testForkedSync(t, avn.AVN66, FullSync) }
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, avn.AVN66, FastSync) }
func TestForkedSync66Light(t *testing.T) { testForkedSync(t, avn.AVN66, LightSync) }
...
func TestHeavyForkedSync65Full(t *testing.T)  { testHeavyForkedSync(t, avn.AVN65, FullSync) }
func TestHeavyForkedSync65Fast(t *testing.T)  { testHeavyForkedSync(t, avn.AVN65, FastSync) }
func TestHeavyForkedSync65Light(t *testing.T) { testHeavyForkedSync(t, avn.AVN65, LightSync) }

func TestHeavyForkedSync66Full(t *testing.T)  { testHeavyForkedSync(t, avn.AVN66, FullSync) }
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, avn.AVN66, FastSync) }
func TestHeavyForkedSync66Light(t *testing.T) { testHeavyForkedSync(t, avn.AVN66, LightSync) }
...
// long dead chains.
func TestBoundedForkedSync65Full(t *testing.T)  { testBoundedForkedSync(t, avn.AVN65, FullSync) }
func TestBoundedForkedSync65Fast(t *testing.T)  { testBoundedForkedSync(t, avn.AVN65, FastSync) }
func TestBoundedForkedSync65Light(t *testing.T) { testBoundedForkedSync(t, avn.AVN65, LightSync) }

func TestBoundedForkedSync66Full(t *testing.T)  { testBoundedForkedSync(t, avn.AVN66, FullSync) }
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, avn.AVN66, FastSync) }
func TestBoundedForkedSync66Light(t *testing.T) { testBoundedForkedSync(t, avn.AVN66, LightSync) }
...
func TestBoundedHeavyForkedSync65Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, avn.AVN65, FullSync)
}
func TestBoundedHeavyForkedSync65Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, avn.AVN65, FastSync)
}
func TestBoundedHeavyForkedSync65Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, avn.AVN65, LightSync)
}

func TestBoundedHeavyForkedSync66Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, avn.AVN66, FullSync)
}
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, avn.AVN66, FastSync)
}
func TestBoundedHeavyForkedSync66Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, avn.AVN66, LightSync)
}
...
func TestCancel65Full(t *testing.T)  { testCancel(t, avn.AVN65, FullSync) }
func TestCancel65Fast(t *testing.T)  { testCancel(t, avn.AVN65, FastSync) }
func TestCancel65Light(t *testing.T) { testCancel(t, avn.AVN65, LightSync) }

func TestCancel66Full(t *testing.T)  { testCancel(t, avn.AVN66, FullSync) }
func TestCancel66Fast(t *testing.T)  { testCancel(t, avn.AVN66, FastSync) }
func TestCancel66Light(t *testing.T) { testCancel(t, avn.AVN66, LightSync) }
...
func TestMultiSynchronisation65Full(t *testing.T)  { testMultiSynchronisation(t, avn.AVN65, FullSync) }
func TestMultiSynchronisation65Fast(t *testing.T)  { testMultiSynchronisation(t, avn.AVN65, FastSync) }
func TestMultiSynchronisation65Light(t *testing.T) { testMultiSynchronisation(t, avn.AVN65, LightSync) }

func TestMultiSynchronisation66Full(t *testing.T)  { testMultiSynchronisation(t, avn.AVN66, FullSync) }
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, avn.AVN66, FastSync) }
func TestMultiSynchronisation66Light(t *testing.T) { testMultiSynchronisation(t, avn.AVN66, LightSync) }
...
func TestMultiProtoSynchronisation65Full(t *testing.T)  { testMultiProtoSync(t, avn.AVN65, FullSync) }
func TestMultiProtoSynchronisation65Fast(t *testing.T)  { testMultiProtoSync(t, avn.AVN65, FastSync) }
func TestMultiProtoSynchronisation65Light(t *testing.T) { testMultiProtoSync(t, avn.AVN65, LightSync) }

func TestMultiProtoSynchronisation66Full(t *testing.T)  { testMultiProtoSync(t, avn.AVN66, FullSync) }
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, avn.AVN66, FastSync) }
func TestMultiProtoSynchronisation66Light(t *testing.T) { testMultiProtoSync(t, avn.AVN66, LightSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 65", avn.AVN65, chain)
	tester.newPeer("peer 66", avn.AVN66, chain)
...
func TestEmptyShortCircuit65Full(t *testing.T)  { testEmptyShortCircuit(t, avn.AVN65, FullSync) }
func TestEmptyShortCircuit65Fast(t *testing.T)  { testEmptyShortCircuit(t, avn.AVN65, FastSync) }
func TestEmptyShortCircuit65Light(t *testing.T) { testEmptyShortCircuit(t, avn.AVN65, LightSync) }

func TestEmptyShortCircuit66Full(t *testing.T)  { testEmptyShortCircuit(t, avn.AVN66, FullSync) }
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, avn.AVN66, FastSync) }
func TestEmptyShortCircuit66Light(t *testing.T) { testEmptyShortCircuit(t, avn.AVN66, LightSync) }
...
func TestMissingHeaderAttack65Full(t *testing.T)  { testMissingHeaderAttack(t, avn.AVN65, FullSync) }
func TestMissingHeaderAttack65Fast(t *testing.T)  { testMissingHeaderAttack(t, avn.AVN65, FastSync) }
func TestMissingHeaderAttack65Light(t *testing.T) { testMissingHeaderAttack(t, avn.AVN65, LightSync) }

func TestMissingHeaderAttack66Full(t *testing.T)  { testMissingHeaderAttack(t, avn.AVN66, FullSync) }
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, avn.AVN66, FastSync) }
func TestMissingHeaderAttack66Light(t *testing.T) { testMissingHeaderAttack(t, avn.AVN66, LightSync) }
...
func TestShiftedHeaderAttack65Full(t *testing.T)  { testShiftedHeaderAttack(t, avn.AVN65, FullSync) }
func TestShiftedHeaderAttack65Fast(t *testing.T)  { testShiftedHeaderAttack(t, avn.AVN65, FastSync) }
func TestShiftedHeaderAttack65Light(t *testing.T) { testShiftedHeaderAttack(t, avn.AVN65, LightSync) }

func TestShiftedHeaderAttack66Full(t *testing.T)  { testShiftedHeaderAttack(t, avn.AVN66, FullSync) }
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, avn.AVN66, FastSync) }
func TestShiftedHeaderAttack66Light(t *testing.T) { testShiftedHeaderAttack(t, avn.AVN66, LightSync) }
...
func TestInvalidHeaderRollback65Fast(t *testing.T) { testInvalidHeaderRollback(t, avn.AVN65, FastSync) }
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, avn.AVN66, FastSync) }
...
func TestHighTDStarvationAttack65Full(t *testing.T) {
	testHighTDStarvationAttack(t, avn.AVN65, FullSync)
}
func TestHighTDStarvationAttack65Fast(t *testing.T) {
	testHighTDStarvationAttack(t, avn.AVN65, FastSync)
}
func TestHighTDStarvationAttack65Light(t *testing.T) {
	testHighTDStarvationAttack(t, avn.AVN65, LightSync)
}

func TestHighTDStarvationAttack66Full(t *testing.T) {
	testHighTDStarvationAttack(t, avn.AVN66, FullSync)
}
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, avn.AVN66, FastSync)
}
func TestHighTDStarvationAttack66Light(t *testing.T) {
	testHighTDStarvationAttack(t, avn.AVN66, LightSync)
}
...
func TestBlockHeaderAttackerDropping65(t *testing.T) { testBlockHeaderAttackerDropping(t, avn.AVN65) }
func TestBlockHeaderAttackerDropping66(t *testing.T) { testBlockHeaderAttackerDropping(t, avn.AVN66) }
...
func TestSyncProgress65Full(t *testing.T)  { testSyncProgress(t, avn.AVN65, FullSync) }
func TestSyncProgress65Fast(t *testing.T)  { testSyncProgress(t, avn.AVN65, FastSync) }
func TestSyncProgress65Light(t *testing.T) { testSyncProgress(t, avn.AVN65, LightSync) }

func TestSyncProgress66Full(t *testing.T)  { testSyncProgress(t, avn.AVN66, FullSync) }
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, avn.AVN66, FastSync) }
func TestSyncProgress66Light(t *testing.T) { testSyncProgress(t, avn.AVN66, LightSync) }
...
func testSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", avalanria.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", avalanria.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", avalanria.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", avalanria.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want avalanria.SyncProgress) {
	// Mark this mavnod as a helper to report errors at callsite, not in here
	t.Helper()
...
// revertal).
func TestForkedSyncProgress65Full(t *testing.T)  { testForkedSyncProgress(t, avn.AVN65, FullSync) }
func TestForkedSyncProgress65Fast(t *testing.T)  { testForkedSyncProgress(t, avn.AVN65, FastSync) }
func TestForkedSyncProgress65Light(t *testing.T) { testForkedSyncProgress(t, avn.AVN65, LightSync) }

func TestForkedSyncProgress66Full(t *testing.T)  { testForkedSyncProgress(t, avn.AVN66, FullSync) }
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, avn.AVN66, FastSync) }
func TestForkedSyncProgress66Light(t *testing.T) { testForkedSyncProgress(t, avn.AVN66, LightSync) }
...
func testForkedSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", avalanria.SyncProgress{
...
func TestFailedSyncProgress65Full(t *testing.T)  { testFailedSyncProgress(t, avn.AVN65, FullSync) }
func TestFailedSyncProgress65Fast(t *testing.T)  { testFailedSyncProgress(t, avn.AVN65, FastSync) }
func TestFailedSyncProgress65Light(t *testing.T) { testFailedSyncProgress(t, avn.AVN65, LightSync) }

func TestFailedSyncProgress66Full(t *testing.T)  { testFailedSyncProgress(t, avn.AVN66, FullSync) }
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, avn.AVN66, FastSync) }
func TestFailedSyncProgress66Light(t *testing.T) { testFailedSyncProgress(t, avn.AVN66, LightSync) }
...
func TestFakedSyncProgress65Full(t *testing.T)  { testFakedSyncProgress(t, avn.AVN65, FullSync) }
func TestFakedSyncProgress65Fast(t *testing.T)  { testFakedSyncProgress(t, avn.AVN65, FastSync) }
func TestFakedSyncProgress65Light(t *testing.T) { testFakedSyncProgress(t, avn.AVN65, LightSync) }

func TestFakedSyncProgress66Full(t *testing.T)  { testFakedSyncProgress(t, avn.AVN66, FullSync) }
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, avn.AVN66, FastSync) }
func TestFakedSyncProgress66Light(t *testing.T) { testFakedSyncProgress(t, avn.AVN66, LightSync) }
...
func TestDeliverHeadersHang65Full(t *testing.T)  { testDeliverHeadersHang(t, avn.AVN65, FullSync) }
func TestDeliverHeadersHang65Fast(t *testing.T)  { testDeliverHeadersHang(t, avn.AVN65, FastSync) }
func TestDeliverHeadersHang65Light(t *testing.T) { testDeliverHeadersHang(t, avn.AVN65, LightSync) }

func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, avn.AVN66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, avn.AVN66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, avn.AVN66, LightSync) }
...
func TestCheckpointEnforcement65Full(t *testing.T) { testCheckpointEnforcement(t, avn.AVN65, FullSync) }
func TestCheckpointEnforcement65Fast(t *testing.T) { testCheckpointEnforcement(t, avn.AVN65, FastSync) }
func TestCheckpointEnforcement65Light(t *testing.T) {
	testCheckpointEnforcement(t, avn.AVN65, LightSync)
}

func TestCheckpointEnforcement66Full(t *testing.T) { testCheckpointEnforcement(t, avn.AVN66, FullSync) }
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, avn.AVN66, FastSync) }
func TestCheckpointEnforcement66Light(t *testing.T) {
	testCheckpointEnforcement(t, avn.AVN66, LightSync)
}
