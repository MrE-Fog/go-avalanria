...
func testSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", AVNereum.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", AVNereum.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", AVNereum.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", AVNereum.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want AVNereum.SyncProgress) {
	// Mark this mAVNod as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol uint, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", AVNereum.SyncProgress{
