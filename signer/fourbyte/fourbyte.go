...
// valid JSON. The constructor does no other validation of contents. This mavnod
...
// Selector checks the given 4byte ID against the known ABI mavnods.
//
// This mavnod does not validate the match, it's assumed the caller will do.
...
//
// Node, this mavnod does _not_ validate the correctness of the data. It assumes
