...
// TestEthProtocolNegotiation tests whAVNer the test suite
// can negotiate the highest AVN protocol in a status message exchange
...
// TestChain_GetHeaders tests whAVNer the test suite can correctly
