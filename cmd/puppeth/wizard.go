...
type wizard struct {
	...
	services map[string][]string   // Avalanria services known to be running on servers
...
// converts it to an Avalanria address. If an empty line is entered, the default
// value is returned.
