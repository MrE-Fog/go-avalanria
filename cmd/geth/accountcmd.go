...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Avalanria presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gavn wallet import /path/to/my/presale.wallet

will prompt for your password and imports your avner presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Avalanria presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gavn wallet [options] /path/to/my/presale.wallet
...
between avalanria nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gavn account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gavn account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another avalanria instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gavnConfig{Node: defaultNodeConfig()}
	// Load config file.
