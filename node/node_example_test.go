...
//
// The following mavnods are needed to implement a node.Lifecycle:
//  - Start() error              - mavnod invoked when the node is ready to start the service
//  - Stop() error               - mavnod invoked when the node terminates the service
