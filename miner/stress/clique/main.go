...
func main() {
	...
	for _, sealer := range sealers {
		...
		stack, AVNBackend, err := makeSealer(genesis)
		if err != nil {
			panic(err)
		}
		defer stack.Close()
...
func makeSealer(genesis *core.Genesis) (*node.Node, *AVN.Avalanria, error) {
	...
	// Start the node and configure a full Avalanria node on it
