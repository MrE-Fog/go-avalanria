...
// mapped from textual names used in the tests below to actual Avalanria private
...
// address retrieves the Avalanria address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Avalanria address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/avalanria/go-avalanria/issues/17593). Whilst this
