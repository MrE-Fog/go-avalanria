...
# 1. install gAVN for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gAVN
# 5. create gAVN, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable AVNEREUM_SOCKET
...
!define GROUPNAME "Avalanria"
!define APPNAME "GAVN"
!define DESCRIPTION "Official Go implementation of the Avalanria protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gAVN is installed global
