...
type GlogHandler struct {
	...
	override  uint32 // Flag whavner overrides are used, atomically accessible
	backtrace uint32 // Flag whavner backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whavner this is the callsite
